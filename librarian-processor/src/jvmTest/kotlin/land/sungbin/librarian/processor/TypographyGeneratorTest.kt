...
class TypographyGeneratorTest : AbstractGeneratorTest(PACKAGE_NAME) {
  @Test fun grouped() {
    ...
    assertThat(result.messages).contains(generatedCatalogInfoMessage("GroupedTypography"))
  ...
  @Test fun oneIgnored() {
    ...
    assertThat(result.exitCode).isOk()
    assertThat(result.messages).contains(generatedCatalogInfoMessage("OneIgnoredTypography"))
  ...
  @Test fun allIgnored() {
    ...
    assertThat(result.messages).contains(generatedCatalogInfoMessage("AllIgnoredTypography"))
  ...
  @Test fun privateProperties() {
    ...
    assertThat(result.exitCode).isOk()
    assertThat(result.messages).contains(generatedCatalogInfoMessage("PrivatePropertiesTypography"))
